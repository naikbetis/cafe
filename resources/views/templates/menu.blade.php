...
<div class="main-menu">
    <div class="row mb-4 no-gutters">
        ...
        <div class="col pl-3 text-left align-self-center">
            <h6 class="mb-1">{{session('user')}}</h6>
            <p class="small text-default-secondary">{{session('email')}}</p>
        </div>
    </div>
    <div class="menu-container">
        {{-- <div class="row mb-4">
            <div class="col">
                <h4 class="mb-1 font-weight-normal">{{session('loggin')}}</h4>
        ...
        <ul class="nav nav-pills flex-column ">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">
                    <div>
                        <i class="material-icons dp48">settings</i>&nbsp
                        Account
                    </div>
